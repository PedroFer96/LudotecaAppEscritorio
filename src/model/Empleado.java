...
public class Empleado {
    ...
    public String toString() {
        return "Empleado{" + "id=" + id + ", nombre=" + nombre + ", apellidos=" + apellidos + ", fechaNacimiento=" + fechaNacimiento + ", dni=" + dni + ", user=" + user + ", password=" + password + ", phone=" + phone + ", correo=" + correo + ", idLudoteca=" + idLudoteca + '}';
    }    
